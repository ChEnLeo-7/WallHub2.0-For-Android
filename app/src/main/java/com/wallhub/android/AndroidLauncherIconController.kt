...
@Singleton
class AndroidLauncherIconController @Inject constructor(
    ...
    private fun String.toComponentName(): ComponentName =
        ComponentName(context, "${context.packageName}.$this")

    private fun PackageManager.isEnabled(
        componentName: ComponentName,
        defaultEnabled: Boolean,
    ): Boolean = when (getComponentEnabledSetting(componentName)) {
