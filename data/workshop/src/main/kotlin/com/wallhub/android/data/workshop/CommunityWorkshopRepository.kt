...
class CommunityWorkshopRepository
    ...
    constructor(
        ...
        private fun buildDetailUrl(workshopId: Long): String =
            Uri
                .Builder()
                .scheme("https")
        ...
        private fun WorkshopBrowseQuery.normalized(): WorkshopBrowseQuery =
            copy(
        ...
        private fun WorkshopBrowseQuery.effectiveRatings(): Set<WorkshopRating> = ratings.ifEmpty { setOf(WorkshopRating.EVERYONE) }

        private fun WorkshopBrowseQuery.communityBrowsePageSize(): Int = if (creatorId == null) pageSize else AUTHOR_BROWSE_PAGE_SIZE
        ...
        private fun WorkshopType.steamTag(): String? =
            when (this) {
        ...
        private fun WorkshopSort.steamApiQueryType(): Int =
            when (this) {
