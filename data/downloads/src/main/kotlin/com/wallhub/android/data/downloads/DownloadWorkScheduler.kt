...
@Singleton
class WorkManagerDownloadWorkScheduler @Inject constructor(
    @ApplicationContext private val context: Context,
) : DownloadWorkScheduler {
    override fun enqueue(taskId: String) {
        val request = OneTimeWorkRequestBuilder<FormalWorkshopDownloadWorker>()
            .setConstraints(
                Constraints.Builder()
...
@Singleton
class WorkManagerConversionWorkScheduler @Inject constructor(
    @ApplicationContext private val context: Context,
) : ConversionWorkScheduler {
    override fun enqueue(taskId: String) {
        val request = OneTimeWorkRequestBuilder<FormalWorkshopConversionWorker>()
...
@Singleton
class WallHubDownloadWorkerFactory @Inject constructor(
    ...
    override fun createWorker(
        ...
        return when (workerClassName) {
            FormalWorkshopDownloadWorker::class.java.name -> FormalWorkshopDownloadWorker(
