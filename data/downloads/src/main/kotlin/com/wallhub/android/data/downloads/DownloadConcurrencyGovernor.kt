...
@Singleton
class DownloadConcurrencyGovernor @Inject constructor() {
    ...
    suspend fun updatePriorities(taskIds: List<String>) {
        mutex.withLock {
            priorityOverrides = taskIds.withIndex().associate { (index, taskId) ->
                taskId to index.toLong()
            }
        }
    }

    private suspend fun acquire(taskId: String, priority: Long, limit: Int) {
