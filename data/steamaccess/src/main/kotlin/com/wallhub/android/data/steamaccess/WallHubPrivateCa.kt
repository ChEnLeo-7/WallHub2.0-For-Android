...
@Singleton
internal class WallHubPrivateCa @Inject constructor() {
    ...
    val clientTrustManager: X509TrustManager = object : X509TrustManager {
    ...
    val clientSocketFactory: SSLSocketFactory = SSLContext.getInstance("TLS").apply {
        init(null, arrayOf(clientTrustManager), random)
    }.socketFactory

    fun createServerSocket(socket: Socket, hostname: String): SSLSocket {
