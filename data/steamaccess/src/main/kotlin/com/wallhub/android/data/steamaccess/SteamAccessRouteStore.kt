...
internal class SteamAccessRouteStore(
    context: Context,
) {
    ...
    fun preferred(
        ...
        return buildList {
            repeat(array.length()) { index ->
                ...
                val address =
                    runCatching { InetAddress.getByName(record.optString("ip")) }.getOrNull()
                        ?: return@repeat
    ...
    private fun update(
        ...
        synchronized(this) {
            ...
            val record =
                records.firstOrNull { it.optString("ip") == address.hostAddress }
    ...
    companion object {
        ...
        internal fun failureCooldown(consecutiveFailures: Int): Long =
            when {
